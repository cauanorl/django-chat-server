...
SECRET_KEY = 'django-insecure-oy!58_ttn8&3jvex1%t&%q%lumnnap2vcbf@b==+v2v_d^v7#u'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['192.168.15.9']
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'social.context_processors.actual_user_friend_requests',
            ],
        },
    },
]
